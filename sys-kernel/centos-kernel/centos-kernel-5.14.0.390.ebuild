...
PATCHES="
	...
	https://gitlab.com/legionus/centos-stream-${RHEL_VER}/-/raw/alt/kernel-${MY_VER}/.rpm/0005-Add-sysctl-to-disable-idmapped-mounts.patch                -> ${P}-0005-Add-sysctl-to-disable-idmapped-mounts.patch
